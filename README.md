...
- `npm run build` - builds your web component and outputs it in your `dist` directory for placement on web servers in a compiled form. Vercel automatically does this on commit to github.3
...
- to improve HAX wiring edit file in `/lib/portfolio-very-theme.haxProperties.json`
